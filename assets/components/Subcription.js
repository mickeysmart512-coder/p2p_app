    ...
    >
      <ScrollView contentContainerStyle={styles.formWrapper}>
        ...
        <View style={styles.card}>
          <Image
            source={require("../images/Frame 35.png")}
            style={styles.overlayImage}
            resizeMode="cover"
          />

          {/* Centered Text */}
          <Text style={styles.transactionText}>Airtel</Text>
        ...
        <View style={styles.detailsCard}>
          ...
          <View style={styles.detailRow}>
            ...
            <Text style={styles.detailValue}>12345678900009876</Text>
          </View>

          <View style={styles.detailRow}>
            <Text style={styles.detailLabel}>Transaction Data</Text>
